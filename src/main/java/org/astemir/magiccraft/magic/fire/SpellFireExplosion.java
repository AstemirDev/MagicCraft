...
import org.astemir.magiccraft.entity.EntityFireExplosionProjectile;
...
public class SpellFireExplosion extends MasterSpell {


    public SpellFireExplosion() {
        super(SpellsConfiguration.FIRE_EXPLOSION);
    }


    @Override
    public void onUse(Player player) {
        EntityFireExplosionProjectile projectile = EntityMagic.create(EntityFireExplosionProjectile.class,player);
