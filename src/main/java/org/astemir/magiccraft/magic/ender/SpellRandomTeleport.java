...
public class SpellRandomTeleport extends MasterSpell {


    public SpellRandomTeleport() {
        super(SpellsConfiguration.RANDOM_TELEPORT);
    }


    private Location randomLocation(Location loc){
        int range = SpellsConfiguration.RANDOM_TELEPORT.getInt("range");
