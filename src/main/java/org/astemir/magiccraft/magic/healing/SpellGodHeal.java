...
public class SpellGodHeal extends MasterSpell {


    public SpellGodHeal() {
        super(SpellsConfiguration.GOD_HEAL);
    }

    @Override
    public void onUse(Player player) {
        player.addPotionEffect(SpellsConfiguration.GOD_HEAL.effect("regeneration").toBukkit());
        MagicUtils.healParticles(player.getLocation().clone().add(0,0.5f,0),15,1.25f);
    ...
    public MagicSpell getRequiredSpell() {
        return Spells.GREAT_HEAL_SPELL;
    }
