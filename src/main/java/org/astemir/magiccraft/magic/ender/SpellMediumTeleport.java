...
public class SpellMediumTeleport extends MasterSpell {


    public SpellMediumTeleport() {
        super(SpellsConfiguration.MEDIUM_TELEPORT);
    }
    ...
    public void onUse(Player player) {
        ...
        Location loc = player.getTargetBlock(SpellsConfiguration.MEDIUM_TELEPORT.getInt("range")).getLocation().add(0,1,0);
    ...
    public MagicSpell getRequiredSpell() {
        return Spells.SMALL_TELEPORT_SPELL;
    }
}
